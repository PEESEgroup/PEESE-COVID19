...
# Write data
target = "C:\\Users\\Akshay\\Documents\\GitHub\\PEESE-COVID19\\ny cases by county - ls.csv"
target2 = "C:\\Users\\Akshay\\Documents\\GitHub\\PEESE-COVID19\\ny cases by county.csv"
...
with open("C:\\Users\\Akshay\\Documents\\GitHub\\PEESE-COVID19\\test.csv", 'w', newline="") as wfile:
    writer = csv.writer(wfile)
    for r in data:
        writer.writerow(r)

with open("C:\\Users\\Akshay\\Documents\\GitHub\\PEESE-COVID19\\test2.csv", 'w', newline="") as wfile:
    writer = csv.writer(wfile)
    for r in data2:
        writer.writerow(r)
